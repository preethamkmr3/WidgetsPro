...
class MusicSimpleWidgetProvider : AppWidgetProvider() {
    ...
    override fun onAppWidgetOptionsChanged(
        ...
        updateAppWidgetInternal(context, appWidgetManager, appWidgetId, drawer, isWidgetVisible)
    }
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (action == ACTION_MEDIA_UPDATE) {
            appWidgetIds.forEach { id ->
                ...
                updateAppWidgetInternal(context, appWidgetManager, id, drawer, isVisible)
            }
            ...
            updateAppWidgetInternal(context, appWidgetManager, targetAppWidgetId, drawer, isVisible)
        } else {
            super.onReceive(context, intent)
        }
    }
    ...
    private fun updateAppWidgetInternal(
        ...
        val shouldVisualize = isPlaying && isWidgetVisible
        ...
        if (hasRequiredPermissions(context)) {
            ...
            if (shouldVisualize) {
                ...
                val pausedBitmap = visualizerDrawer.getVisualizerBitmap()
                if (pausedBitmap != null && !pausedBitmap.isRecycled) {
                    views.setImageViewBitmap(R.id.visualizer_image_view, pausedBitmap)
                } else {
                    views.setImageViewBitmap(R.id.visualizer_image_view,
                        createEmptyBitmap(visualizerDrawer.visualizerWidth, visualizerDrawer.visualizerHeight))
                }
            }
        } else {
            visualizerDrawer.pause()
